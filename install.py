...
####################################################################################################
# About module file
_MODULE_FILE_NAME = "vertexLock.mod"
_MODULE_NAME = "vertexLock"
_MODULE_VERSION = "1.0.0"
_SCRIPTS_DIR_NAME = "src"

# About shelf button
_COMMAND = """import maya_vertex_lock_ui as scr<COMMAND_NEW_LINE>reload(scr)<COMMAND_NEW_LINE>scr.execute()<COMMAND_NEW_LINE>"""
